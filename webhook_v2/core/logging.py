...
def get_logger(name: str = None) -> structlog.stdlib.BoundLogger:
    ...
    Usage:
        ...
        log.info("processing_email", email_id=123, classification="new_lead")
    """
...
def bind_context(**kwargs) -> None:
    ...
    Usage:
        bind_context(email_id=123, message_id="abc")
        log.info("processing")  # Will include email_id and message_id
    """

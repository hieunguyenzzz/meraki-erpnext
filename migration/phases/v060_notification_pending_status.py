"""Update notification Server Scripts to include is_pending flag based on referenced document status."""
...
SCRIPTS = {
    "get_my_notifications": (
        ...
        '    n["message"] = msg\n'
        '\n'
        '# Enrich with is_pending flag\n'
        'actionable = {"Leave Application", "Purchase Invoice", "Attendance Request"}\n'
        'for n in notifications:\n'
        '    dt = n.get("reference_document_type") or ""\n'
        '    dn = n.get("reference_document_name") or ""\n'
        '    n["is_pending"] = False\n'
        '    if dt in actionable and dn:\n'
        '        if dt == "Leave Application":\n'
        '            st = frappe.db.get_value("Leave Application", dn, "status")\n'
        '            n["is_pending"] = st == "Open"\n'
        '        elif dt == "Purchase Invoice":\n'
        '            ds = frappe.db.get_value("Purchase Invoice", dn, "docstatus")\n'
        '            n["is_pending"] = ds == 0\n'
        '        elif dt == "Attendance Request":\n'
        '            ds = frappe.db.get_value("Attendance Request", dn, "docstatus")\n'
        '            n["is_pending"] = ds == 0\n'
        '\n'
...
def run(client):
    """Update notification Server Scripts to include is_pending flag."""

"""Update handle_notification_action Server Script to support Purchase Invoice approve/reject."""
...
def run(client):
    """Update handle_notification_action Server Script to support PI approve/reject."""

"""Add custom_probation_end_date to meraki-set-employee-fields Server Script allowlist."""
...
DATE_FIELDS_SET = """{
    ...
    "custom_last_review_date", "custom_probation_end_date",
}"""
...
def run(client):
    ...
    if result:
        print("  Updated meraki-set-employee-fields (custom_probation_end_date added)")
    else:

        ...
        <Sheet open={deleteOpen} onOpenChange={setDeleteOpen}>
          <SheetContent side="right" className="sm:max-w-sm flex flex-col p-0">
            <SheetHeader className="px-6 py-4 border-b shrink-0">
              <SheetTitle>Delete Opportunity</SheetTitle>
            </SheetHeader>
            <div className="px-6 py-4">
              <p className="text-sm text-muted-foreground">Are you sure you want to delete this opportunity? This action cannot be undone.</p>
            </div>
